...
exports.throwNoValueAttribute = function(infos) {
  infos.attribute = "value";
  throwError(ERRORS.NO_ATTRIBUTE, infos);
};

exports.throwSwitchWithoutCase = function(infos) {
  throwError("<Switch> statement requires at least one <Case> element!", infos);
};

exports.throwSwitchDefaultNotLast = function(infos) {
  throwError("<Default> must be the last element within a <Switch> statement!", infos);
}

// 只能一个default
exports.throwSwitchWithMultipleDefault = function(infos) {
  throwError("<Switch> statement allows only for one <Default> block!", infos);
};